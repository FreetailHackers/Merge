  ...
  handleUpdate = (event) => {
    ...
    this.setState(
      ...
      () => {
        ...
        axios
          .post(process.env.REACT_APP_API_URL + "/auth/update", {
      ...
      <div className="profile-container">
        <div className="profile-child">
          <section id="settings">
            <form>
              ...
              />
              <RadioGroup label="How competitive are you?">
                <Radio
                  value="learn"
              ...
              <MultiSelect
                ...
                onCreate={(query) =>
                  SVGMetadataElement((current) => [...current, query])
                }
              />
            </form>
            <button onClick={this.handleSubmit} className="action" id="save">
              Save
            </button>
        ...
        <div className="profile-child">
          <SwipeProfile
            ...
            profilePictureUrl={this.getOrEmptyString(
