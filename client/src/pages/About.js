  ...
  return (
    <div className="about-page">
      ...
      <p>
        ...
        , Merge is the <strong>first</strong> real-time chat app of its kind for
        use in hackathons. It was first thought of in 2021 as a fun way to
        handle team matching and an alternative to people attempting to reach
        out in public channels in hopes of finding other people wanting a team.
        After lots of work, it has evolved into a fully fledged chat app taking
        inspiration from some uh, other popular apps centered around connecting
        people together.
      </p>
      <br />
      <h3>The Story</h3>
      <p>
        ...
        previous project lead), Ayush B, Ayush P, and Ben G (beloved members of
        Freetail). In the beginning stages of the project, a large teardown of
        the original codebase commenced.
      </p>
      <p>
        We kept a large portion of the original UI, but rewrote large parts of
        the codebase. We also wrote almost all of the backend again from scratch
        and implemented the vast majority of features you see today. In total,
        the current team has devoted hundreds of hours to the development of
        Merge over the course of 7 total months of consistent effort to finally
        complete the first <strong>early access</strong> release for Spring
        2023. Special thanks to Orion (previous Logistics Director) for being a
        fantastic resource while we (mostly Adi) worked with full-scale and
        industry level development -&gt; production pipelines and cloud hosting
        on AWS.
      </p>
      <br />
      <h3>Future Steps</h3>
      <p>
        ...
        across the country and by most major hackathons. We are extremely proud
        to be finally releasing Merge, especially because{" "}
        <strong>
