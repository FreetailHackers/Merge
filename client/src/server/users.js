...
export function addUserRoutes (server) {
  ...
  server.get("github/user/:username", (schema, request) => {
    ...
    return {
      ...
      "following_url": "https://api.github.com/users/bintay/following{/other_user}",
      ...
      "received_events_url": "https://api.github.com/users/bintay/received_events",
      "type": "User",
      "site_admin": false,
      "name": "Ben Taylor",
      "company": null,
